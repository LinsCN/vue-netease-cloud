    ...
    <footer>
        <div class="footer-first">
            ...
            <div class="footer-first-right">
                <p class="footer-first-right-one">+收藏({{obj.tracksLength-3}})</p>
            </div>
        </div>
        <div class="footer-second" v-for="(item,index) in obj.tracks">
